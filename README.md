...
compute_intelligence.py
     │
     ├── ICP Scoring (per entity type, 0–100 scale)
     ├── Digital Maturity Scoring (0–4 per entity)
     ├── TAM / SAM / SOM Calculation
     ├── Zone-Level Aggregations (34 zones)
     ├── Type-Level Aggregations (29 types)
...
geo_intelligence.js (window.GEO_INTELLIGENCE)
     │
     ▼
index.html (CDIOS Dashboard)
     │
     ├── Executive KPI Rendering
     ├── Chart.js Visualizations
     ├── Leaflet.js Interactive Map
     └── JS Bridge Renderers (12 modules)
```
